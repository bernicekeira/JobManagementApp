...
class EmployeeViewModel(var navController: NavHostController, var context: Context) {
    ...
    fun saveEmployeeWithImage(employeeName:String, employeeContact:String, employeeEmail:String, filePath: Uri){
        var id = System.currentTimeMillis().toString()
        ...
        storageReference.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageReference.downloadUrl.addOnSuccessListener {
                    ...
                    var houseData = Upload(employeeName,employeeContact,
                        employeeEmail,imageUrl,id)
